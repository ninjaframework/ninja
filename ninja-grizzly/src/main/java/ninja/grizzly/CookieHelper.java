...
public class CookieHelper {
    ...
    public static Cookie convertNinjaCookieToGrizzlyCookie(ninja.Cookie cookie) {
        Cookie grizzlyCookie = new Cookie(cookie.getName(), cookie.getValue());
    ...
    public static ninja.Cookie convertGrizzlyCookieToNinjaCookie(
