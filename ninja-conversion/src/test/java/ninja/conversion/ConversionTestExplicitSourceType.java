...
public class ConversionTestExplicitSourceType {
    ...
    @Test
    public void testCanConvertByTypeTrue() {
        final boolean actual = conversion.canConvert(String.class, Integer.class);

        Assert.assertTrue(actual);
    }

    @Test
    public void testCanConvertByTypeFalse() {
        final boolean actual = conversion.canConvert(String.class, BigDecimal.class);
    ...
    public void testIterable() {
        ...
        final List<Integer> actualList = conversion.convert(valueIterable, String.class, Integer.class);
    ...
    public void testIterableNull() {
        ...
        final List<Integer> actualSet = conversion.convert(valueList, String.class, Integer.class);
    ...
    public void testList() {
        ...
        final List<Integer> actualList = conversion.convert(valueList, String.class, Integer.class);
    ...
    public void testListUnknownConverter() {
        final List<String> valueList = Arrays.asList("1", "-42", "1337");
        conversion.convert(valueList, String.class, BigDecimal.class);
    }
    ...
    public void testSet() {
        ...
        final Set<Integer> actualSet = conversion.convert(valueSet, String.class, Integer.class);
    ...
    public void testSetNull() {
        ...
        final Set<Integer> actualSet = conversion.convert(valueList, String.class, Integer.class);
    ...
    public void testSimpleValue() {
        final Integer actual = conversion.convert("42", String.class, Integer.class);
    ...
    public void testSimpleValueNull() {
        final Integer actual = conversion.convert((String) null, String.class, Integer.class);
