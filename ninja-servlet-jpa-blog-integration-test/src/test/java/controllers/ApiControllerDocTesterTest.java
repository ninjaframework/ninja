...
public class ApiControllerDocTesterTest extends NinjaDocTester {
    ...
    public void testGetAndPostArticleViaJson() throws Exception {
        ...
        Response apiResponse = makeRequest(
                Request.GET().url(
        ...
        apiResponse = makeRequest(Request.POST().url(
                testServerUrl().path(POST_ARTICLE_URL.replace("{username}", USER)))
                .payload(articleDto));
        ...
        apiResponse = makeRequest(Request.GET().url(testServerUrl().path(GET_ARTICLES_URL.replace("{username}", "bob@gmail.com"))));
