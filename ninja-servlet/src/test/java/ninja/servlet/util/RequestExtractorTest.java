...
public class RequestExtractorTest {
	...
	private ArgumentExtractor<HttpServletRequest> requestExtractor;
	...
	public void testGetFieldName() {
		assertNull("This method call must always returns null", requestExtractor.getFieldName());
	}
	...
	public void testExtractException() {
		...
		// when
		requestExtractor.extract(context);
	...
	public void testExtract() {
		...
		// when
		requestExtractor.extract(ninjaServletContext);

		// then
		verify(ninjaServletContext).getHttpServletRequest();
	}

	@Test
	public void testGetExtractedType() {
		assertEquals("Extracted Type must be equal to servlet response type", HttpServletRequest.class,
				requestExtractor.getExtractedType());
	}
}