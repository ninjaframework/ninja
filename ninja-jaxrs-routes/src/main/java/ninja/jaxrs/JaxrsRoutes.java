 ...
 */
@Singleton
public class JaxrsRoutes implements ApplicationRoutes {

    final static Logger logger = LoggerFactory.getLogger(JaxrsRoutes.class);
    ...
    @Inject
    public JaxrsRoutes(NinjaProperties ninjaProperties) {
